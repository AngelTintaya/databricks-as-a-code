...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE g0_catalog.default.basic_input AS
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE g0_catalog.default.basic_transform AS 
# MAGIC SELECT
# MAGIC     inp.id,
# MAGIC     inp.producto,
# MAGIC     inp.cantidad,
...
# MAGIC FROM g0_catalog.default.basic_input inp
# MAGIC WHERE inp.id IS NOT NULL

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE TABLE g0_catalog.default.basic_summary AS
# MAGIC SELECT
# MAGIC   producto,
# MAGIC   SUM(total) AS total_sum
# MAGIC FROM g0_catalog.default.basic_transform
