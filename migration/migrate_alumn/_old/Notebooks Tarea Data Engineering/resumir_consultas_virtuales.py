# Databricks notebook source
 ...
 # dbutils.widgets.text("TABLE_SUMMARY_CONSULTAS_VIRTUALES", "g5_catalog.gold.consultas_virtuales_summary")

# COMMAND ----------

TABLE_TRANSFORM_CONSULTAS_VIRTUALES = dbutils.widgets.get("TABLE_TRANSFORM_CONSULTAS_VIRTUALES")
TABLE_SUMMARY_CONSULTAS_VIRTUALES = dbutils.widgets.get("TABLE_SUMMARY_CONSULTAS_VIRTUALES")

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP TABLE IF EXISTS ${TABLE_SUMMARY_CONSULTAS_VIRTUALES}

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE TABLE ${TABLE_SUMMARY_CONSULTAS_VIRTUALES} AS
# MAGIC SELECT
# MAGIC     enfermedad,
...
# MAGIC
# MAGIC FROM ${TABLE_TRANSFORM_CONSULTAS_VIRTUALES}
...
# MAGIC %sql
# MAGIC SELECT * FROM ${TABLE_SUMMARY_CONSULTAS_VIRTUALES}