...
# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW g0_cmc_ventas.silver.vw_ventas
# MAGIC AS
# MAGIC SELECT
# MAGIC   venta_id,
# MAGIC   cliente_id,
...
# MAGIC   creado,
# MAGIC   inserted_at
# MAGIC FROM g0_cmc_ventas.bronze.raw_ventas_ecommerce
# MAGIC UNION ALL
# MAGIC SELECT
# MAGIC   venta_id,
# MAGIC   cliente_id,
...
# MAGIC   creado,
# MAGIC   inserted_at
# MAGIC FROM g0_cmc_ventas.bronze.raw_ventas_tienda
# MAGIC

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP MATERIALIZED VIEW IF EXISTS g0_cmc_ventas.silver.mv_ventas

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE MATERIALIZED VIEW g0_cmc_ventas.silver.mv_ventas
# MAGIC (
...
# MAGIC FROM g0_cmc_ventas.silver.vw_ventas

# COMMAND ----------

# MAGIC %sql
# MAGIC REFRESH MATERIALIZED VIEW g0_cmc_ventas.silver.mv_ventas