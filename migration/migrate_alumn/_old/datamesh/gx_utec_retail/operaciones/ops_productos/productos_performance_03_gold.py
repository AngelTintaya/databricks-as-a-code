...
dbutils.widgets.text('SILVER_TB_UM_PROD_PERF', 'gx_ops_productos.silver.um_producto_performance')
dbutils.widgets.text('SILVER_TB_HM_PROD_PERF', 'gx_ops_productos.silver.hm_producto_performance')
dbutils.widgets.text('GOLD_VW_UM_PROD_PERF', 'gx_ops_productos.gold.vw_um_producto_performance')
dbutils.widgets.text('GOLD_VW_HM_PROD_PERF', 'gx_ops_productos.gold.vw_hm_producto_performance')
