...
spark.sql('SELECT * FROM vw_quarantine_staging').display()
...
"""
TARGET: Tabla Silver --> ID: 01, cantidad=10
BRONZE: Toda la data nueva --> ID: 01, cantidad=-15

SOURCE: Vista VALIDADA de Silver --> NO TIENE ID 01 --> ID 14
QUARENTINE: Vista datos INVALIDOS en Silver --> Tiene ID 01

MERGE
=====
TARGET: Tabla Silver --> (DELETE) SIN ID: 01, cantidad=10
QUARENTINE: Vista datos INVALIDOS en Silver --> Tiene ID 01
BRONZE: Toda la data nueva --> ID: 01, cantidad=15
