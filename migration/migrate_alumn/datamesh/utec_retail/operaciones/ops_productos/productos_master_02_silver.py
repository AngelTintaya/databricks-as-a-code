...
# MAGIC %md
# MAGIC ## CHOOSE CLUSTER COMPUTE COMPUTE
...
dbutils.widgets.text('SILVER_MV_INVENTARIO', f'{my_catalog}.silver.mv_inventario')
dbutils.widgets.text('BRONZE_TB_RAW_INVENTARIO', f'{my_catalog}.bronze.raw_inventario')
...
# MAGIC %sql
# MAGIC DROP MATERIALIZED VIEW IF EXISTS IDENTIFIER(:SILVER_MV_INVENTARIO)
...
# MAGIC %sql
# MAGIC REFRESH MATERIALIZED VIEW IDENTIFIER(:SILVER_MV_INVENTARIO)