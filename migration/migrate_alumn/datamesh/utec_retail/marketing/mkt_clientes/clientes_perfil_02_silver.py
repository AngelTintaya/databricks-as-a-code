...
# MAGIC %sql
# MAGIC DROP MATERIALIZED VIEW IF EXISTS IDENTIFIER(:SILVER_MV_CLIENTES_PERFIL)
...
# MAGIC %sql
# MAGIC REFRESH MATERIALIZED VIEW IDENTIFIER(:SILVER_MV_CLIENTES_PERFIL)