...
# MAGIC %sql
# MAGIC DROP VIEW IF EXISTS ga_cmc_ventas.gold.vw_ventas;
# MAGIC DROP VIEW IF EXISTS ga_cmc_ventas.gold.vw_ventas_por_canal;
# MAGIC DROP VIEW IF EXISTS ga_cmc_ventas.gold.vw_ventas_por_producto;

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW ga_cmc_ventas.gold.vw_ventas
...
# MAGIC   created_at,
# MAGIC   inserted_at
# MAGIC FROM ga_cmc_ventas.silver.mv_ventas

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW ga_cmc_ventas.gold.vw_ventas_por_canal
# MAGIC (
# MAGIC   cod_mes,
...
# MAGIC FROM ga_cmc_ventas.gold.vw_ventas
# MAGIC GROUP BY
# MAGIC   cod_mes,
# MAGIC   fecha_venta,
# MAGIC   canal
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW ga_cmc_ventas.gold.vw_ventas_por_producto
# MAGIC (
