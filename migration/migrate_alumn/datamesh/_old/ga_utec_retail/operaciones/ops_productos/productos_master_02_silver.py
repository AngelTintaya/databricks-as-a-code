...
dbutils.widgets.text('SILVER_MV_INVENTARIO', 'ga_ops_productos.silver.mv_inventario')
dbutils.widgets.text('BRONZE_TB_RAW_INVENTARIO', 'ga_ops_productos.bronze.raw_inventario')
