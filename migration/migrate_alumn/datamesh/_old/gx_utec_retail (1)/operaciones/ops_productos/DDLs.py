...
BRONZE_TB_RAW_INVENTARIO = 'gx_ops_productos.bronze.raw_inventario'
SILVER_TB_UM_PROD_PERF = 'gx_ops_productos.silver.um_producto_performance'
SILVER_TB_HM_PROD_PERF = 'gx_ops_productos.silver.hm_producto_performance'
