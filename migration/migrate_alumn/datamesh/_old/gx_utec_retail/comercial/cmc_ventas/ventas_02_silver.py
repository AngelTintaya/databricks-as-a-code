...
# MAGIC %sql
# MAGIC CREATE OR REPLACE VIEW gx_cmc_ventas.silver.vw_ventas
# MAGIC AS
# MAGIC SELECT
# MAGIC   venta_id,
# MAGIC   cliente_id,
...
# MAGIC   fecha,
# MAGIC   inserted_at
# MAGIC FROM gx_cmc_ventas.bronze.raw_ventas_ecommerce
# MAGIC UNION ALL
# MAGIC SELECT
# MAGIC   venta_id,
# MAGIC   cliente_id,
...
# MAGIC   fecha,
# MAGIC   inserted_at
# MAGIC FROM gx_cmc_ventas.bronze.raw_ventas_tienda
# MAGIC

# COMMAND ----------

# MAGIC %sql
# MAGIC DROP MATERIALIZED VIEW IF EXISTS gx_cmc_ventas.silver.mv_ventas

# COMMAND ----------

# MAGIC %sql
# MAGIC CREATE OR REPLACE MATERIALIZED VIEW gx_cmc_ventas.silver.mv_ventas
# MAGIC (
...
# MAGIC FROM gx_cmc_ventas.silver.vw_ventas

# COMMAND ----------

# MAGIC %sql
# MAGIC REFRESH MATERIALIZED VIEW gx_cmc_ventas.silver.mv_ventas