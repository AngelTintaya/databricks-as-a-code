...
my_catalog = 'gx00_ops_productos'

# COMMAND ----------

# dbutils.widgets.text('SILVER_TB_UM_PROD_PERF', f'{my_catalog}.silver.um_producto_performance')
# dbutils.widgets.text('SILVER_TB_HM_PROD_PERF', f'{my_catalog}.silver.hm_producto_performance')
# dbutils.widgets.text('GOLD_VW_UM_PROD_PERF', f'{my_catalog}.gold.vw_um_producto_performance')
# dbutils.widgets.text('GOLD_VW_HM_PROD_PERF', f'{my_catalog}.gold.vw_hm_producto_performance')
