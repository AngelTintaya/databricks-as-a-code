...
BRONZE_SCHEMA = f'{my_group}_mkt_clientes.bronze'
SILVER_SCHEMA = f'{my_group}_mkt_clientes.silver'
GOLD_SCHEMA = f'{my_group}_mkt_clientes.gold'
...
SUPPORT_SCHEMA = f'{my_group}_mkt_clientes.support'
